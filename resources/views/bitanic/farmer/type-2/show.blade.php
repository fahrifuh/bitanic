<x-app-layout>
    ...
    {{-- Header --}}
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a href="{{ route('bitanic.farmer.index') }}">Data Petani</a> / </span>{{ $user->name }}</h4>
    </x-slot>
    {{-- End Header --}}
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <div class="text-center">
                                <img src="{{ asset($user->farmer->picture) }}" alt="user-avatar" class="rounded" height="100" width="100" id="uploadedAvatar" />
                                <h5 class="card-title mt-3">{{ $user->name }}</h5>
                                <a href="#" title="Edit data toko" class="btn btn-sm btn-icon btn-warning"><i class="bx bx-edit-alt"></i></a>
                                <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-outline-danger"><i class="bx bx-trash"></i></a>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                @foreach ($farmer_menus as $farmer_menu)
                    <div class="col-12 col-md-4">
                        <a href="{{ $farmer_menu['url'] }}">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-0"><i class="bx {{ $farmer_menu['icon'] }} fs-2"></i> {{ $farmer_menu['title'] }}</h5>
                                </div>
                            </div>
                        </a>
                    </div>
