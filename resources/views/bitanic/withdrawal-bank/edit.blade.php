<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a
                    href="{{ route('bitanic.withdrawal-bank.index') }}">Bank Penarikan</a> /
            <a href="{{ route('bitanic.withdrawal-bank.show', $withdrawalBank->id) }}">{{ $withdrawalBank->name }}</a> /</span> Edit bank {{ $withdrawalBank->name }}</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.withdrawal-bank.update', $withdrawalBank->id) }}" method="POST" id="form-product"
                        ...
                        <div class="row g-2">
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <img src="{{ asset($withdrawalBank->picture ?? 'bitanic-landing/default-image.jpg') }}"
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                ...
                                <input type="text" id="data-input-name" class="form-control" name="name"
                                    value="{{ $withdrawalBank->name }}" required />
                            </div>
                            <div class="col mb-3">
                                ...
                                <input type="text" id="data-input-code" class="form-control" name="code"
                                    value="{{ $withdrawalBank->code }}" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <textarea class="form-control" id="data-input-description" name="description" rows="5"
                                    >{{ $withdrawalBank->description }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
