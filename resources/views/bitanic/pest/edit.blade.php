<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a
                    href="{{ route('bitanic.pest.index') }}">Data Hama</a> / <a
                    href="{{ route('bitanic.pest.show', $pest->id) }}">{{ $pest->pest_type }}</a> /</span> Edit data</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.pest.update', $pest->id) }}" method="POST" id="form-product"
                        ...
                        <div class="row">
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <img src="{{ asset($pest->picture) }}" alt="preview-img"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <select class="form-select" id="data-input-tanaman-id" name="crop_id"
                                    ...
                                    @forelse ($crops as $id => $crop)
                                        <option value="{{ $id }}"
                                            @if ($id == $pest->crop_id) selected @endif>{{ $crop }}
                                        </option>
                                    @empty
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="text" id="data-input-type" class="form-control" name="pest_type"
                                    value="{{ $pest->pest_type }}" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="data-input-features" class="form-label">Ciri-ciri Hama</label>
                                <textarea class="form-control" id="data-input-features" name="features" rows="2">{{ $pest->features }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="data-input-symptomatic" class="form-label">Gejala pada Tanaman</label>
                                <textarea class="form-control" id="data-input-symptomatic" name="symptomatic" rows="2">{{ $pest->symptomatic }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="data-input-precautions" class="form-label">Pencegahan HPT</label>
                                <textarea class="form-control" id="data-input-precautions" name="precautions" rows="2">{{ $pest->precautions }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="data-input-countermeasures" class="form-label">Penanggulangan HPT</label>
                                <textarea class="form-control" id="data-input-countermeasures" name="countermeasures" rows="2">{{ $pest->countermeasures }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
