<x-app-layout>
    {{-- Header --}}
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Transaksi Produk Bitanic</h4>
    </x-slot>
    {{-- End Header --}}
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($transactions as $transaction)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="right"
                                            ...
                                            <i class='bx bx-info-circle' style="cursor: pointer;"
                                                ...
                                                data-bs-html="true" data-bs-content="<p>{{ $transaction->code }}</p>"
                                                title="Order ID"></i>
                                        </span>
                                    </td>
                                    <td>
                                        @if ($transaction->transaction_item->bitanic_product_id)
                                            <a
                                                href="{{ route('bitanic.bitanic-product.show', $transaction->transaction_item->bitanic_product_id) }}" title="Klik untuk melihat produk">{{ $transaction->transaction_item->bitanic_product->name }}</a>
                                        @else
                                    ...
                                    <td>Rp {{ number_format_1($transaction->total) }}</td>
                                    <td>
                                        <a href="{{ route('bitanic.transaction.show', $transaction->id) }}"
                                            class="btn btn-info btn-icon btn-sm" title="Detail Transaksi">
