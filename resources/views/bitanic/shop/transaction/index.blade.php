<x-app-layout>
    {{-- Header --}}
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a href="{{ route('bitanic.shop.index') }}">Toko</a> /</span> Transaksi</h4>
    </x-slot>
    {{-- End Header --}}
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($farmerTransactions as $farmerTransaction)
                                <tr>
                                    ...
                                    <td><a href="{{ route('bitanic.shop.transaction-show', $farmerTransaction->id) }}" class="btn btn-sm btn-info">Detail</a></td>
                                </tr>
                            @empty
                                <tr>
