<x-app-layout>
    ...
    {{-- Header --}}
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a href="{{ route('bitanic.device.index') }}">Data Perangkat</a> / {{ $device->device_series }} /</span> Edit core data </h4>
    </x-slot>
    {{-- End Header --}}
                    ...
                    <form action="{{ route('bitanic.device.update', $device->id) }}" method="POST" id="form-product" enctype="multipart/form-data">
                        ...
                        <div class="row g-2">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <img src="{{ asset($device->picture ?? 'bitanic-landing/default-image.jpg') }}" alt="preview-foto" class="preview-image img-thumbnail rounded-3">
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-select" id="data-input-petani-id" name="farmer_id" aria-label="Default select example">
                                    @if (auth()->user()->role != 'farmer')
                                        <option value="" @if($device->farmer_id == null) selected @endif>Tanpa Petani</option>
                                    @endif
