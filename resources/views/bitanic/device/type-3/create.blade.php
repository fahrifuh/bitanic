<x-app-layout>
    ...
    {{-- Header --}}
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a href="{{ route('bitanic.device.index') }}">Data Perangkat Bitanic Pro & RSC</a> </span>/ Tambah </h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.v3-device.store') }}" method="POST" id="form-product" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="number" min="0" max="10" id="data-input-delay" class="form-control" name="delay" value="5" required />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="number" min="0" step=".1" class="form-control" name="r" required />
                            </div>
                            <div class="col-12 col-md-4">
                                <label for="data-input-duration" class="form-label">Tinggi Toren (cm)</label>
                                <input type="number" min="0" step=".1" class="form-control" name="tinggi_toren" required />
                            </div>
                            <div class="col-12 col-md-4">
                                <label for="data-input-duration" class="form-label">Volume Toren (Liter)</label>
                                <input type="number" min="1" step="0.01" class="form-control" name="v_toren" disabled />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12 col-md-4">
                                <label for="data-input-duration" class="form-label">Tinggi Awal (CM)</label>
                                <input type="number" min="0" step=".01" class="form-control" name="tinggi_awal" />
                            </div>
                            <div class="col-12 col-md-4">
                                <label for="data-input-duration" class="form-label">Tinggi Akhir (CM)</label>
                                <input type="number" min="0" step=".01" class="form-control" name="tinggi_akhir" />
                            </div>
                            <div class="col-12 col-md-4">
                                <label for="data-input-duration" class="form-label">Volume air dari tinggi awal</label>
                                <input type="number" step=".01" class="form-control" name="v_fron_t_toren" disabled />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12 col-md-6">
                                <label for="data-input-duration" class="form-label">Debit (Liter) / menit</label>
                                <input type="number" step=".01" class="form-control" name="debit" disabled />
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="data-input-duration" class="form-label">Durasi (Menit:Detik)</label>
                                <input type="text" class="form-control" name="duration" disabled />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
    ...
    <script>
        ...
        const newSpesifikasi = (formElement) => {
            formElement.insertAdjacentHTML("beforeend", `<div class="row g-2 mb-3 custom-spesifikasi">
                ...
                <div class="col-2 mb-0 d-grid gap-2">
                    <button type="button" class="btn btn-danger btn-block mt-3 btn-delete-element">X</button>
                </div>
            </div>`)
