    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        action="{{ route('bitanic.device.update-pe', ['device' => $device->id, 'pe' => 'vertigation']) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12" id="form-vertigasi">
                                @foreach ($device->vertigation as $vertigation)
                                    <div class="d-flex gap-2">
                                        <div class="flex-grow-1">
                                            <label class="form-label">PE</label>
                                            <input type="text" class="form-control data-input-vertigation"
                                                name="vertigations[]" value="new" readonly />
                                        </div>
