<x-app-layout>
    ...
    {{-- Header --}}
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a href="{{ route('bitanic.lite-device.index') }}">Perangkat Lite</a> /</span> Buat data baru</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.lite-device.store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="data-input-tanaman-id" class="form-label">ID Perangkat</label>
                                <select class="form-select" id="data-input-tanaman-id" name="lite_series_id"
                                    aria-label="Default select example">
                                    @forelse ($lite_series as $id => $prefix)
                        ...
                        <div class="row">
                            <div class="col mb-3">
                              ...
                              <input type="text" id="data-input-levels" class="form-control" name="version" value="{{ old('version') }}" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
