<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a
                    href="{{ route('bitanic.lite-device.index') }}">Perangkat Lite</a> / <a
                    href="{{ route('bitanic.lite-device.show', $lite_device->id) }}">{{ $lite_device->full_series }}</a>
            </span>/ Edit Pompa {{ $lite_device_pump->id }} </h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        action="{{ route('bitanic.lite-device.lite-device-pump.update', ['lite_device' => $lite_device->id, 'lite_device_pump' => $lite_device_pump->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <!-- Validation Errors -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-check form-check-inline mt-3">
                                    <input class="form-check-input" type="radio" name="is_active" id="inlineRadio1"
                                        value="1" @if ($lite_device_pump->is_active == 1) checked @endif />
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_active" id="inlineRadio2"
                                        value="0" @if ($lite_device_pump->is_active == 0) checked @endif />
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    <input type="number" step=".01" class="form-control" name="min_tds"
                                        value="{{ $lite_device_pump->min_tds }}" />
                            ...
                            <div class="col-12 col-md-6">
                                <div class="input-group">
                                    <input type="number" step=".01" class="form-control" name="max_tds"
                                        value="{{ $lite_device_pump->max_tds }}" />
