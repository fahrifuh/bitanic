<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a
                    href="{{ route('bitanic.lite-user.index') }}">Petani Lite</a> /</span> Buat data baru</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.lite-user.store') }}" method="POST" id="form-product"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="row g-2">
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <select class="form-select" id="data-input-tanaman-id" name="gender"
                                            ...
                                            <option value="male" selected>{{ __('Laki - laki') }}</option>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" class="form-control" id="data-input-nik" name="nik"
                                            value="{{ old('nik') }}" placeholder="0" aria-label="0"
                                ...
                                <div class="row g-2">
                                    <div class="col mb-3">
                                        ...
                                        <input type="date" class="form-control" id="data-input-birth-date"
                                            name="birth_date" value="{{ old('birth_date') }}" placeholder="0"
                                ...
                                <div class="row g-2">
                                    <div class="col mb-3">
                                        ...
                                        <input type="password" class="form-control" id="data-input-password"
                                            name="password" aria-label="0" aria-describedby="basic-addon13" />
                                    </div>
                                    <div class="col mb-3">
                                        <label for="data-input-password-confirmation" class="form-label">Konfirmasi
                                            Password</label>
                                        <input type="password" class="form-control"
                                            id="data-input-password-confirmation" name="password_confirmation"
                                            aria-label="0" aria-describedby="basic-addon13" />
                                    </div>
                                </div>
                            </div>
