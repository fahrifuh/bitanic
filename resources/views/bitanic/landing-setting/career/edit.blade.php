<x-app-layout>
    ...
    <x-slot name="header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fs-4">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('bitanic.career.show', $career->id) }}">{{ $career->position }}</a>
                </li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.career.update', $career->id) }}" method="POST" id="form-product"
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                id="defaultCheck3" @if($career->is_looking ? true : false) checked @endif
                                                name="is_looking">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="data-input-position" class="form-control"
                                            name="position" value="{{ $career->position }}" required />
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="data-input-department" class="form-control"
                                            name="department" value="{{ $career->department }}" required />
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="data-input-work-hour" class="form-control"
                                            name="work_hour" value="{{ $career->work_hour }}" required />
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-location" class="form-label">Lokasi</label>
                                        <input type="text" id="data-input-location" class="form-control"
                                            name="location" value="{{ $career->location }}" required />
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-description" class="form-label">Deskripsi</label>
                                        <textarea class="form-control" id="data-input-description" name="description" rows="5">{{ $career->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                            ...
                                            @foreach ($career->requirements as $requirement)
                                                <div class="d-flex flex-wrap gap-2">
                                                    ...
                                                    <div class="flex-shrink-1 align-self-end">
                                                        <button class="btn btn-icon btn-danger btn-delete-element"
                                                            title="Hapus Biaya"><i
                                                                class="bx bx-trash event-none"></i></button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
