                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="float-end m-3">
                            <a href="{{ route('bitanic.career.create') }}" class="btn btn-icon btn-primary" title="Tambah Karir">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($careers as $career)
                                <tr>
                                    <td>{{ ($careers->currentPage() - 1) * $careers->perPage() + $loop->iteration }}</td>
                                    <td>
                                        {{ $career->position }}
                                    </td>
                                    <td>
                                        ...
                                        ]) onclick="changeStatus(this)" data-id="{{ $career->id }}"
                                            data-name="{{ $career->position }}">{{ $career->is_looking ? 'Dicari' : 'Tidak dicari' }}</button>
                                    </td>
                                    <td>{{ $career->department }}</td>
                                    <td>{{ $career->work_hour }}</td>
                                    <td>{{ $career->location }}</td>
                                    <td>
                                        <a href="{{ route('bitanic.career.show', $career->id) }}"
                                            class="btn btn-info btn-icon btn-sm" title="Detail Karir">
                                            <i class="bx bx-list-ul"></i>
                                        </a>
                                        <a href="{{ route('bitanic.career.edit', $career->id) }}"
                                            class="btn btn-warning btn-icon btn-sm" title="Edit Karir">
                                            <i class="bx bx-edit"></i>
                                        </a>
                                        <button type="button" onclick="deletePest(this)" data-id="{{ $career->id }}"
                                            data-name="{{ $career->position }}" class="btn btn-danger btn-sm btn-icon"
                                            title="Hapus Bank">
