<x-app-layout>
    ...
    <x-slot name="header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fs-4">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('bitanic.service.show', $service->id) }}">{{ $service->title }}</a>
                </li>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.service.update', $service->id) }}" method="POST" id="form-product"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <img src="{{ asset($service->icon ?? 'bitanic-landing/flower-glowing-icon.svg') }}" alt="preview-img" class="preview-image img-thumbnail">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input class="form-control" type="file" id="data-input-image" name="picture"
                                            accept="image/png, image/jpg, image/jpeg, image/svg" aria-describedby="pictureHelp" />
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="data-input-title" class="form-control"
                                            name="title" value="{{ $service->title }}" required />
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-description" class="form-label">Deskripsi</label>
                                        <textarea class="form-control" id="data-input-description" name="description" rows="5">{{ $service->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
