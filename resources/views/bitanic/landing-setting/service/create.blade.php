<x-app-layout>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.service.store') }}" method="POST" id="form-product"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <img src="{{ asset('bitanic-landing/flower-glowing-icon.svg') }}" alt="preview-img" class="preview-image img-thumbnail">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
