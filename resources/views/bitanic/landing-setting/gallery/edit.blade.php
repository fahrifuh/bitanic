<x-app-layout>
    ...
    <x-slot name="header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fs-4">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('bitanic.gallery.index') }}">Galeri</a>
                </li>
                <li class="breadcrumb-item">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.gallery.update', $gallery->id) }}" method="POST" id="form-product"
                            ...
                            <div class="col-12">
                                <div class="row mb-3">
                                    <div class="col-12 mb-3">
                                        ...
                                        <img src="{{ asset($gallery->picture ?? 'bitanic-landing/default-image.jpg') }}" alt="preview-img"
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="data-input-description" name="description" rows="5">{{ $gallery->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
