<x-app-layout>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.faq.update', $faq->id) }}" method="POST" id="form-product">
                        @csrf
                        @method('PUT')
                        <!-- Validation Errors -->
                            ...
                            <div class="col-12">
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="data-input-answer" name="answer" rows="5">{{ $faq->answer }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
