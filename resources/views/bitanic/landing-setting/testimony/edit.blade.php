<x-app-layout>
    ...
    <x-slot name="header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fs-4">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('bitanic.testimony.show', $testimony->id) }}">{{ $testimony->name }}</a>
                </li>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.testimony.update', $testimony->id) }}" method="POST" id="form-product"
                            ...
                            <div class="col-12">
                                <div class="row mb-3">
                                    <div class="col-12 col-sm-4 mb-3">
                                        ...
                                        <img src="{{ asset($testimony->picture ?? 'bitanic-landing/default-image.jpg') }}" alt="preview-img"
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="star-rating">
                                            @for ($i = 5; $i >= 1; $i--)
                                                <input type="radio" id="star{{ $i }}" name="rating" value="{{ $i }}" @if($i == $testimony->rating) checked @endif>
                                                <label for="star{{ $i }}" title="{{ $i }} stars"><i class='bx bxs-star'></i></label>
                                            @endfor
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-comment" class="form-label">Komen</label>
                                        <textarea class="form-control" id="data-input-comment" name="comment" rows="5">{{ $testimony->comment }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
