<x-app-layout>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.product.store') }}" method="POST" id="form-product"
                            ...
                            <div class="col-12">
                                <div class="row mb-3">
                                    <div class="col-12 mb-3">
                                        ...
                                        <img src="{{ asset('bitanic-landing/default-image.jpg') }}"
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" min="0" id="data-input-price"
                                                class="form-control" name="price" value="{{ old('price') }}" />
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="data-input-tags" class="form-control" name="tags"
                                            value="{{ old('tags') }}" placeholder="tag 1, tag 2, tag n..." aria-describedby="tagsHelp" required />
