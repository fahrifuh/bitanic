        ...
        <div class="col-md-12">
            ...
            <div class="nav-align-top mb-4">
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('bitanic.feedback-lite.index') }}" class="nav-link"
                            aria-selected="false">
        ...
        <script>
            const deletePest = async e => {
                ...
                const [data, error] = await yourRequest(
                    "{{ route('bitanic.feedback-regular.destroy', 'ID') }}".replace('ID',
