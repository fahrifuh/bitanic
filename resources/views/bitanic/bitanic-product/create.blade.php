<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a
                    href="{{ route('bitanic.bitanic-product.index') }}">Produk Bitanic</a> /</span> Buat data baru</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.bitanic-product.store') }}" method="POST" id="form-product"
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                ...
                                <select class="form-select" id="data-input-category" name="category"
                                    ...
                                    <option value="controller">Kontroller Bitanic Pro</option>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="0" class="form-control" name="price"
                                        value="{{ old('price') }}" autocomplete="billing" required />
                                </div>
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0" max="100" class="form-control" name="discount"
                                        value="{{ old('discount') }}" autocomplete="billing" />
