<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master / <a
                    href="{{ route('bitanic.crop-for-sale.index') }}">Tanaman untuk dijual</a> / <a href="{{ route('bitanic.crop-for-sale.show', $cropForSale->id) }}">{{ $cropForSale->name }}</a> /</span> Edit</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.crop-for-sale.update', $cropForSale->id) }}" method="POST" id="form-product"
                        ...
                        <div class="row g-2">
                            <div class="col mb-3">
                                ...
                                <input type="text" id="data-input-name" class="form-control" name="name"
                                    value="{{ $cropForSale->name }}" required />
                            </div>
                            <div class="col mb-3">
                                ...
                                <input type="number" min="1" max="360" id="data-input-days" class="form-control" name="days"
                                    value="{{ $cropForSale->days }}" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
