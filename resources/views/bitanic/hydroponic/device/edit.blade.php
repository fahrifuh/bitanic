<x-app-layout>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.hydroponic.device.update', $hydroponicDevice->id) }}" method="POST" id="form-product"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" id="data-input-user" name="user_id"
                                            ...
                                            @foreach ($hydroponicUsers as $id => $name)
                                                <option value="{{ $id }}" @if($id == $hydroponicDevice->user_id) selected @endif>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12">
                                        <div class="row g-2">
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="date" id="data-input-production-date"
                                                    ...
                                                    value="{{ $hydroponicDevice->production_date }}" />
                                            </div>
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="date" id="data-input-purchase-date" class="form-control"
                                                    name="purchase_date" value="{{ $hydroponicDevice->purchase_date }}" />
                                            </div>
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="date" id="data-input-activation-date"
                                                    ...
                                                    value="{{ $hydroponicDevice->activation_date }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-note" class="form-label">Note</label>
                                        <textarea class="form-control" id="data-input-note" name="note" rows="5">{{ $hydroponicDevice->note }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
