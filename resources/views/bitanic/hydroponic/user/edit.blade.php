<x-app-layout>
    ...
    <x-slot name="header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fs-4">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('bitanic.hydroponic.user.show', $hydroponicUser->id) }}">{{ $hydroponicUser->name }}</a>
                </li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.hydroponic.user.update', $hydroponicUser->id) }}" method="POST"
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="data-input-name" class="form-control" name="name"
                                            value="{{ $hydroponicUser->name }}" required />
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-email" class="form-label">Email</label>
                                        <input type="email" id="data-input-email" class="form-control" name="email"
                                            value="{{ $hydroponicUser->email }}" required />
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-username" class="form-label">Username</label>
                                        <input type="text" id="data-input-username" class="form-control"
                                            name="username" value="{{ $hydroponicUser->username }}" required />
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" id="data-input-gender" name="gender"
                                            ...
                                            @foreach ($userGenders as $userGender)
                                                <option value="{{ $userGender->value }}"
                                                    @if($userGender->value == $hydroponicUser->gender->value) selected @endif>
                                                    {{ $userGender->getLabelText() }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" pattern="8[0-9]{8,}" class="form-control"
                                                id="data-input-phone-number" name="phone_number"
                                                placeholder="8xxxxxxxxx" value="{{ $hydroponicUser->phone_number }}"
                                                aria-describedby="basic-addon13" />
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label for="data-input-address" class="form-label">Alamat</label>
                                        <textarea class="form-control" id="data-input-address" name="address" rows="5">{{ $hydroponicUser->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="row g-2">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <img src="{{ asset($hydroponicUser->picture ?? 'bitanic-landing/default-profile.png') }}"
