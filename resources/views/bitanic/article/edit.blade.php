<x-app-layout>
    ...
    <x-slot name="header">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Mobile / <a
                    href="{{ route('bitanic.article.index') }}">Data Artikel</a> / {{ $article->title }} /</span> Edit</h4>
    </x-slot>
    {{-- End Header --}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitanic.article.update', $article->id) }}" method="POST" id="form-product"
                        ...
                        <div class="row g-2">
                            <div class="col-12 col-md-3">
                                ...
                                <img src="{{ asset($article->picture ?? 'bitanic-landing/default-image.jpg') }}" alt="preview-img"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-select" id="data-input-tipe" name="type"
                                    ...
                                    <option value="sayuran" @if($article->type == 'sayur') selected @endif>Sayuran</option>
                                    <option value="buah" @if($article->type == 'buah') selected @endif>Buah</option>
                                    <option value="umum" @if($article->type == 'umum') selected @endif>Umum</option>
                                    <option value="tentang_kami" @if($article->type == 'tentang_kami') selected @endif>Tentang Kami</option>
                                    <option value="visi_misi" @if($article->type == 'visi_misi') selected @endif>Visi & Misi</option>
                                </select>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="data-input-writer" class="form-control" name="writer" value="{{ $article->writer }}">
                            </div>
                            <div class="col-12">
