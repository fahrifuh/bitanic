    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="data-input-nama" class="form-label">Nama Penjual</label>
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="data-input-segmen-pasar" class="form-label">Segmen Pasar</label>
                        <input type="text" id="data-input-segmen-pasar" class="form-control" name="nama_investasi" />
                    </div>
                </div>
                <div class="row">
                  <div class="col mb-3">
